...
info = """
[\033[91mSIN\033[00m] \033[91mCortex, Made By Envy, Re Coded from AQUA,
i liked this scripts, so i simply re coded it,
i will be adding new methods all the time,
stay tuned. 
AQUAs Biggest Attack
31.9 gbps
Cortexs, Biggest Attack,
Not Recorded, (Most Likely The Same As AQUA.)
"""
...
altbanner = """
		      ...
		      AQUA people are punished put in hell
...
def main():
	...
	while True:
		sys.stdout.write("\x1b]2;AQUA V1\x07")
		sin = input("\033[1;00m[\033[91mAQUA\033[1;00m]-\033[91m家\033[00m ").lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (altbanner)
